...
/* -------------------------------------------------------------------------- */
uint32_t gf_alog(uint32_t x) // calculate anti-logarithm gen 3
{
    uint32_t atb = 1, z;
...
/* -------------------------------------------------------------------------- */
uint32_t gf_log(uint32_t x) // calculate logarithm gen 3
{
    uint32_t atb = 1, i = 0, z;
...
/* -------------------------------------------------------------------------- */
uint32_t gf_mulinv(uint32_t x) // calculate multiplicative inverse
{
    return (x) ? gf_alog(255 - gf_log(x)) : 0;
} /* gf_mulinv */

/* -------------------------------------------------------------------------- */
uint32_t rj_sbox(uint32_t x)
{
    uint32_t y, sb;
...
/* -------------------------------------------------------------------------- */
uint32_t rj_xtime(uint32_t x)
{
    return (x & 0x80) ? ((x << 1) ^ 0x1b) : (x << 1);
} /* rj_xtime */

/* -------------------------------------------------------------------------- */
void aes_subBytes(uint32_t *buf)
{
...
/* -------------------------------------------------------------------------- */
void aes_addRoundKey(uint32_t *buf, uint32_t *key)
{
    register uint32_t i = 16;
...
/* -------------------------------------------------------------------------- */
void aes_addRoundKey_cpy(uint32_t *buf, uint32_t *key, uint32_t *cpk)
{
    register uint32_t i = 16;
...
/* -------------------------------------------------------------------------- */
void aes_shiftRows(uint32_t *buf)
{
    register uint32_t i, j; /* to make it potentially parallelable :) */
...
/* -------------------------------------------------------------------------- */
void aes_mixColumns(uint32_t *buf)
{
...
/* -------------------------------------------------------------------------- */
void aes_expandEncKey(uint32_t *k, uint32_t *rc)
{
    register uint32_t i;
...
A3_KERNEL(a3in_t key, a3in_t enckey, a3in_t deckey, a3in_t k, a3inout_t buf) {
    //INIT
    uint32_t rcon = 1;
    uint32_t i;
