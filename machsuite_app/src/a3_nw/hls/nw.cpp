...
A3_KERNEL(a3in_t M, a3in_t ptr, a3inout_t pack) {

    /* ARTICo³ unpacking */
    a3data_t *SEQA = &pack[0];
    a3data_t *SEQB = &pack[ALEN];
    a3data_t *alignedA = &pack[ALEN+BLEN];
    a3data_t *alignedB = &pack[2*(ALEN+BLEN)];
